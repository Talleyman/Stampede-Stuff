...
then
	...
	echo "$inputPED not found."
fi
if [ -f inputMAP ]
then
	echo "$inputMAP found."
else
	echo "$inputMAP not found."
fi
if [ -f $inputTPED ]
then
	echo "$inputTPED found."
else
	echo "$inputTPED not found."
fi
if [ -f "$inputTFAM" ]
then
	echo "$inputTFAM found."
else
	echo "$inputTFAM not found."
fi
if [ -f "$inputBED" ]
then
	echo "$inputBED found."
else
	echo "$inputBED not found."
fi
if [ -f "$inputBIM" ]
then
	echo "$inputBIM found."
else
	echo "$inputBIM not found."
fi
if [ -f "$inputBAM" ]
then
	echo "$inputBAM found."
